<div>
                ...
                <div class="col-md-6 text-end">
                    ...
                    <div class="time-spent" wire:poll.1s="updateTimeSpent">
                        ...
                        <small class="text-muted ms-2">/
                            {{ !empty($evaluation->duration) ? formateTime($evaluation->duration * 60) : 'Illimité' }}
                        </small>
                    </div>
    ...
    <form wire:submit.prevent="submit">
        ...
        <div id="questions-container">
            ...
            @endphp
            @if ($currentQuestion)
                <div class="question-card card active fade-in" wire:key="question-{{ $currentQuestion->id }}">
                    <div class="card-body">
                        <!-- Indicateur de chargement -->
                        <div wire:loading.attr="nextQuestion,previousQuestion,goToQuestion" style="display: none;">
                            ...
                            <div class="answers-container mt-3">
                                @if ($currentQuestion->type === 'text')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="text-answer-{{ $currentQuestion->id }}" class="form-control" rows="4"
                                            placeholder="Tapez votre réponse ici..." wire:model.live="currentAnswer"
                                ...
                                @else
                                    ...
                                    @foreach ($currentQuestion->answers as $answerIndex => $answer)
                                        ...
                                        @endphp
                                        <div class="answer-option p-3 mb-3 border rounded d-flex align-items-start {{ $isSelected ? 'selected' : '' }}"
                                            wire:click="selectAnswer({{ $answer->id }})"
                                            wire:key="answer-{{ $answer->id }}">
                                            <strong>{{ chr(65 + $answerIndex) }})</strong>
                                            <div class="me-3">
                                                    ...
                                                    @if ($currentQuestion->type === 'find_intruder')
                                                        @if (!$answer->is_correct)
                                                            <span class="badge bg-warning ms-2">
                                                                <i class="bi bi-exclamation-triangle"></i> Intrus
                                                                possible
                                                            </span>
                                                        @endif
                                                    @endif
                                    ...
                                    @if ($currentQuestion->type === 'multiple_choice')
                                        <div class="alert alert-info mt-3">
                                            ...
                                            <small>Vous pouvez sélectionner plusieurs réponses pour cette
                                                question.</small>
                                        </div>
        ...
        <div class="card mt-4">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <button type="button" id="prev-btn" class="btn btn-outline-secondary"
                    ...
                    <div class="col-md-6 text-end">
                        ...
                        @else
                            <button type="button" id="next-btn" class="btn btn-primary" wire:click="nextQuestion">
                                <span class="btn-content">
    ...
    <script>
        ...
        Livewire.on('questionChanged', (index) => {
            ...
            const currentCard = document.querySelector(
                `[wire\\:key="question-{{ $questions[$currentQuestionIndex]->id ?? '' }}"]`);
            if (currentCard) {
                setTimeout(() => {
        ...
        function updateProgressBar() {
            ...
            if (progressBar) {
                ...
                const targetWidth =
                    {{ $questions->count() > 0 ? round((($currentQuestionIndex + 1) / $questions->count()) * 100, 2) : 0 }};
