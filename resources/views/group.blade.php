...
@section('page-title', 'LADATEMA GROUP — Portail Officiel')
...
<div class="container py-3 group-viewport">
    ...
    <div class="row g-3">
            ...
            <div class="portal-card-unified">
                <div>
                    <div class="portal-logo-box mb-3">
                        <img src="{{ asset('images/LOGO_LADATEMA_SARL.png') }}" alt="LADATEMA Research" class="portal-logo-img">
                    </div>
                ...
                <div>
                    <a href="{{ route('welcome') }}" class="btn-brand-action">
        ...
        <div class="col-md-6 col-lg-3">
            <div class="portal-card-unified">
                <div>
                    <div class="portal-logo-box mb-3">
                        <img src="{{ asset('images/lada-bourse.png') }}" alt="Lada Bourse" class="portal-logo-img">
                    </div>
                ...
                <div>
                    <a href="{{ asset('lada/bourse.html') }}" target="_blank" rel="noopener noreferrer" class="btn-brand-action">
                        <span>Accéder au Portail</span>
        ...
        <div class="col-md-6 col-lg-3">
            <div class="portal-card-unified">
                <div>
                    <div class="portal-logo-box mb-3">
                        <img src="{{ asset('images/lada-rh.png') }}" alt="Lada RH" class="portal-logo-img">
                    </div>
                ...
                <div>
                    <a href="{{ asset('lada/rh.html') }}" target="_blank" rel="noopener noreferrer" class="btn-brand-action">
                        <span>Accéder au Portail</span>
                        <i class="bi bi-box-arrow-up-right"></i>
                    </a>
                </div>
        ...
        <div class="col-md-6 col-lg-3">
            <div class="portal-card-unified">
                <div>
                    <div class="portal-logo-box mb-3">
                        <img src="{{ asset('images/lada-finance.png') }}" alt="Lada Finance" class="portal-logo-img">
                    </div>
                ...
                <div>
                    <a href="{{ asset('lada/finance.html') }}" target="_blank" rel="noopener noreferrer" class="btn-brand-action">
                        <span>Accéder au Portail</span>
                        <i class="bi bi-box-arrow-up-right"></i>
                    </a>
                </div>
    ...
    <div class="d-flex flex-wrap align-items-center justify-content-between bg-white rounded-4 p-3 mt-3 border shadow-sm fs-7 text-muted">
        ...
        <div class="d-flex gap-3">
            <a href="{{ route('contact.form') }}" class="text-primary fw-bold text-decoration-none">
                <i class="bi bi-envelope-fill me-1"></i> Formulaire de Contact
            </a>
            <span class="text-light">|</span>
            <a href="{{ route('nos.services') }}" class="text-secondary fw-bold text-decoration-none">
